...
LABEL = 'Thermal Event Attribution Workbench'
FIXTURE = 'thermal_event_cases.jsonl'
ANALYSIS = 'thermal_attribution_analysis.json'
CSV_NAME = 'thermal_interventions.csv'
DASHBOARD_TITLE = 'Thermal Attribution Decisions'
...
SLUG = 'thermal-event-attribution-workbench'
